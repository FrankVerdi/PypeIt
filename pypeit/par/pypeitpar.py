...
class TelluricPar(ParSet):
    ...
    def __init__(self, telgridfile=None, sn_clip=None, resln_guess=None, resln_frac_bounds=None,
        ...
        descr['tell_npca'] = (
            'Number of telluric PCA components used. Can be set to any number '
            'from 1 to 10.'
        )
        ...
        descr['pix_shift_bounds'] = (
            'Bounds for the pixel shift optimization in the telluric model fit in '
        ...
        descr['lower'] = (
            ...
            'that rejection is not too agressive in cases where the empirical '
        ...
        dtypes['disp'] = bool
        descr['disp'] = (
            'Argument for `scipy.optimize.differential_evolution`_ that will '
        ...
        dtypes['pca_file'] = str
        descr['pca_file'] = (
            'Fits file containing quasar PCA model. Needed for the QSO model.  If '
            'you change the default, you might need to set ``pca_lower`` and '
            '``pca_upper``.'
        )
        ...
        descr['fit_wv_min_max'] = (
            'Pixels within this mask will be used during the fitting. The format '
    ...
    def validate(self):
        ...
        # JFH add something in here which checks that the recombination value
        # provided is between 0 and 1, although
